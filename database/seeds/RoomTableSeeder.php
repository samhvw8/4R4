...
class RoomTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $streets_bd = ['An Xa', 'Ba Huyen Thanh Quan', 'Bac Son', 'Buoi', 'Cao Ba Quat', 'Cau Giay', 'Chau Long', 'Chu Van An', 'Chua Mot Cot', 'Cua Bac', 'Dang Dung', 'Dang Tat', 'Dao Tan', 'Dien Bien Phu', 'Doc Lap', 'Doc Ngu', 'Doi Can', 'Doi Nhan', 'Giang Van Minh', 'Giang Vo', 'Hang Bun', 'Hang Dau', 'Hang Than', 'Hoang Dieu', 'Hoang Hoa Tham', 'Hoang Van Thu', 'Hoe Nhai', 'Hong Ha', 'Hong Phuc', 'Hung Vuong', 'Huynh Thuc Khang', 'Khuc Hao', 'Kim Ma', 'Kim Ma Thuong', 'La Thanh', 'Lac Chinh', 'Lang Ha', 'Le Duan', 'Le Hong Phong', 'Le Truc', 'Lieu Giai', 'Linh Lang', 'Ly Nam De', 'Mac Dinh Chi', 'Mai Anh Tuan', 'Nam Cao', 'Nam Trang', 'Nghia Dung', 'Ngoc Ha', 'Ngoc Khanh', 'Ngu Xa', 'Nguyen Bieu', 'Nguyen Canh Chan', 'Nguyen Chi Thanh', 'Nguyen Cong Hoan', 'Nguyen Hong', 'Nguyen Khac Hieu', 'Nguyen Khac Nhu', 'Nguyen Pham Tuan', 'Nguyen Thai Hoc', 'Nguyen Thiep', 'Nguyen Tri Phuong', 'Nguyen Trung Truc', 'Nguyen Truong To', 'Nguyen Van Ngoc', 'Nui Truc', 'Ong Ich Khiem', 'Pham Hong Thai', 'Pham Huy Thong', 'Phan Dinh Phung', 'Phan Huy Ich', 'Phan Ke Binh', 'Pho Duc Chinh', 'Phuc Xa', 'Quan Ngua', 'Quan Thanh', 'Son Tay', 'Tan Ap', 'Thanh Bao', 'Thanh Cong', 'Thanh Nien', 'Ton That Dam', 'Ton That Thiep', 'Tran Huy Lieu', 'Tran Phu', 'Tran Te Xuong', 'Tran Vu', 'Truc Bach', 'Van Bao', 'Van Cao', 'Van Phuc', 'Vinh Phuc', 'Yen Ninh', 'Yen Phu', 'Yen The'];
        $wards_bd = ['Khuong Thuong', 'Cong Vi', 'Dien Bien', 'Doi Can', 'Giang Vo', 'Kim Ma', 'Lieu Giai', 'Ngoc Ha', 'Ngoc Khanh', 'Nguyen Trung Truc', 'Phuc Xa', 'Quan Thanh', 'Thanh Cong', 'Truc Bach', 'Vinh Phuc'];
        ...
        foreach (range(1, 20) as $index) {
            try {
                DB::table('rooms')->insert([
                    ...
                    'street' => rand(1, 100) . ' ' . $streets_bd[array_rand($streets_bd)],
                    'district' => 'Ba Dinh',
                    'ward' => $wards_bd[array_rand($wards_bd)],
                    'city' => 'Hanoi',
        ...
        foreach (range(1, 20) as $index) {
            try {
                DB::table('rooms')->insert([
                    ...
                    'description' => $faker->text(150),
                    'image_album_url' => $faker->imageUrl(),
                    'street' => rand(1, 100) . ' ' . $streets_hbt[array_rand($streets_hbt)],
                    'district' => 'Hai Ba Trung',
                    'ward' => $wards_hbt[array_rand($wards_hbt)],
                    'city' => 'Hanoi',
                    'created_at' => new DateTime(),
                    'updated_at' => new DateTime()
                ]);
